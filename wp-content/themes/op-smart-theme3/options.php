    ...
    $fields = array(
        ...
        array(
            ...
            'required'  => array(
                ...
                array($prefix . '_integration_type_' . $nr, 'not', 'zapier'),
                array($prefix . '_integration_type_' . $nr, 'not', 'sendy'),
            ),
        ),
        array(
            'id'        => $prefix . '_list_sendy_' . $nr,
            'type'      => 'text',
            'title'     => _x('Integration List', 'Optin Forms', 'op3_smart'),
            'subtitle'     => _x('Enter your list ID.', 'Optin Forms', 'op3_smart'),
            'default'   => '',
            'class'     => 'op-integration-type-list',
            'required'  => array(
                array($prefix . '_integration_type_' . $nr, 'equals', array('sendy')),
            ),
        ),
        array(
            'id'        => $prefix . '_tag_' . $nr,
            'type'      => 'select',
            'title'     => _x('Integration Tag', 'Optin Forms', 'op3_smart'),
            'options'   => array('' => _x('Select Integration Type first', 'Optin Forms', 'op3_smart')),
            'default'   => '',
        ...
        array(
            'id'        => $prefix . '_goal_' . $nr,
            'type'      => 'select',
            'title'     => _x('Integration Goal', 'Optin Forms', 'op3_smart'),
            'options'   => array('' => _x('Select Integration Type first', 'Optin Forms', 'op3_smart')),
            'default'   => '',
            'class'     => 'op-integration-type-goal',
            'required'  => array(
                array($prefix . '_integration_type_' . $nr, 'equals', array('campaignrefinery')),
            )
        ),
        array(
            'id'        => $prefix . '_webhook_' . $nr,
            'type'      => 'text',
            'title'     => _x('Webhook URL', 'Optin Forms', 'op3_smart'),
            'default'   => '',
            'required'  => array(
                // array($prefix . '_form_enabled', 'equals', true),
                // array('integration_current', 'equals', $nr),
                array($prefix . '_integration_type_' . $nr, 'equals', array('webhook', 'zapier')),
            )
        ),
        array(
        ...
        array(
            ...
            'required'  => array(
                // array($prefix . '_form_enabled', 'equals', true),
                // array('integration_current', 'equals', $nr),
                array($prefix . '_integration_type_' . $nr, 'equals', array('activecampaign')),
            ),
        ),
        array(
...
function opOptinSection($prefix, $name, $disabled_fields = array(), $defaults = false)
{
    ...
    for ($j = 1; $j <= $integrations_nr; $j++) {
        $id = (isset($op_options['op3_integration_settings_integration_id_' . $j])) ? $op_options['op3_integration_settings_integration_id_' . $j] : $j;
        $name = (isset($op_options['op3_integration_settings_integration_name_' . $j])) ? $op_options['op3_integration_settings_integration_name_' . $j] : 'Integration #' . $j;
